...
python ./igr_pipe.py a0v-ab $UTDATE --correct-flexure --lacosmic-thresh=2 #Reduce A0V standard star data
python ./igr_pipe.py a0v-onoff $UTDATE --correct-flexure --lacosmic-thresh=2
python ./igr_pipe.py tell-wvsol $UTDATE --lacosmic-thresh=2 #Use telluric absorption in A0V std star to fine tune wavelength solution
python ./igr_pipe.py stellar-ab $UTDATE --correct-flexure  --lacosmic-thresh=2 #Reduce stellar sources nod on slit
python ./igr_pipe.py stellar-onoff $UTDATE --correct-flexure  --lacosmic-thresh=2 #Reduce stellar sources nod off slit
python ./igr_pipe.py extended-ab $UTDATE --correct-flexure --height-2dspec=100  --lacosmic-thresh=2 #Reduce extended sources nod on slit
python ./igr_pipe.py extended-onoff $UTDATE --correct-flexure --height-2dspec=100  --lacosmic-thresh=2 #Reduce extended sources not off slit
